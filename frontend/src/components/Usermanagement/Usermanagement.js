              ...
              <form className="create-user" onSubmit={handleSubmit}>
                <div className="create-user-left">
                  ...
                  <div className="multi-fields">
                    ...
                    {/* Department dropdown with search: with search functionality */}
                    {/* <input
                      required
                      name="departmentName"
                      onChange={handleInputChange}
...
//       const filtered = departments.filter((dept) =>
//         dept.toLowerCase().includes(data.departmentName.toLowerCase())
//       );
//       setFilteredDepartments(filtered);
//     } else {
//       setFilteredDepartments(departments); // Show all if no input
//     }
//   };
...
//                       required
//                       name="departmentName"
//                       onFocus={handleDepartmentFocus} // Show dropdown on focus
//                       onChange={handleInputChange}
//                       value={data.departmentName}
//                       type="text"
//                       placeholder="Department"
...
//                             onClick={() => {
//                               setData((prevData) => ({ ...prevData, departmentName: dept }));
//                               setFilteredDepartments([]); // Close dropdown after selection
//                             }}
//                           >
//                             {dept}
//                           </li>
